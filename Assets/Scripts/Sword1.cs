...
public class Sword1 : MonoBehaviour
{
            ...
            switch (item.s)
            {
                case "P": // point
                    ...
                    if (age < 1)
                    {
                        ...
                        newString.Add(new Symbol("V", new object[] { 1, 0.0f, 1.0f })); // age, angle, distance ratio
                        newString.Add(new Symbol("V", new object[] { 1, 45.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 90.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 135.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 180.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 225.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 270.0f, 1.0f }));
                        newString.Add(new Symbol("V", new object[] { 1, 315.0f, 1.0f }));
                        newString.Add(new Symbol("]", new object[] { }));
                    ...
                    {
                        newString.Add(new Symbol("[", new object[] { }));
                        newString.Add(new Symbol("V", new object[] { 1, 0.0f, 0.3f })); // age, angle, distance ratio
                        newString.Add(new Symbol("V", new object[] { 1, 45.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 90.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 135.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 180.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 225.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 270.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 315.0f, 0.3f }));
                        newString.Add(new Symbol("]", new object[] { }));
                        newString.Add(new Symbol("U", new object[] { 1.0f })); // distance
                    }
                    else if (age < 10)
                    {
                        newString.Add(new Symbol("[", new object[] { }));
                        newString.Add(new Symbol("V", new object[] { 1, 0.0f, 1.5f })); // age, angle, distance ratio
                        newString.Add(new Symbol("V", new object[] { 1, 0.0f, 1.5f })); // age, angle, distance ratio
                        newString.Add(new Symbol("V", new object[] { 1, 90.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 90.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 180.0f, 1.5f }));
                        newString.Add(new Symbol("V", new object[] { 1, 180.0f, 1.5f }));
                        newString.Add(new Symbol("V", new object[] { 1, 270.0f, 0.3f }));
                        newString.Add(new Symbol("V", new object[] { 1, 270.0f, 0.3f }));
                        newString.Add(new Symbol("]", new object[] { }));
    ...
    void DrawQuadrangle(Vector3 p0, Vector3 p1, Vector3 p2, Vector3 p3, int j)
    {
        Vector3 normal = Vector3.Cross(p2 - p0, p1 - p0).normalized;
        int triOffset = vertices.Count;
